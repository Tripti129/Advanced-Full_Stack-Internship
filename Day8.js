...
async function getUser() {
    return { id: 1, name: "Tripti", city: "Panipat" };
}
...
//     return { name: "Tripti", age: 21, course: "MERN" };
// }
...
// Q11.
// function getUser() {
//     return Promise.resolve({ id: 1, name: "Tripti" });
// }
// async function main() {
...
// async function getUser() { await wait(500); return { id: 1, name: "Tripti" }; }
...
// Q38.
// async function getUser() { return { id: 1, name: "Tripti" }; }
// async function getOrders() { return ["Order1", "Order2"]; }
// async function getProducts() { return ["Laptop", "Mouse"]; }
